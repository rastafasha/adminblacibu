export class Reccertificado{
  constructor(
    ...
    public cert_act_academicas_y_asistenciales_status: string,
    ...
    public trab_esp_y_art_cientificos_status: string,
    ...
    public act_editor_revisor_pub_cient_status: string,
    ...
    public cert_asist_simposio_de_especialidad_status: string,
    ...
    public cert_asist_simposio_no_especialidad_status: string,
  ){}
}
